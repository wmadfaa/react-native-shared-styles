...
function createPalette(options) {
    var _a = options.primary, primary = _a === void 0 ? {
        light: indigo[300],
        main: indigo[500],
        dark: indigo[700],
        contrastText: "#FFFFFF"
    } : _a, _b = options.secondary, secondary = _b === void 0 ? {
        light: pink.A200,
        main: pink.A400,
        dark: pink.A700,
        contrastText: "rgba(0, 0, 0, 0.87)"
    } : _b, _c = options.type, type = _c === void 0 ? "light" : _c, _d = options.contrastThreshold, contrastThreshold = _d === void 0 ? 14 : _d, _e = options.tonalOffset, tonalOffset = _e === void 0 ? 0.2 : _e, other = __rest(options, ["primary", "secondary", "type", "contrastThreshold", "tonalOffset"]);
    var getContrastText = function (background) {
        var color$1 = color;
        return color$1(background).contrast(color$1(light.text.onSurface.highEmphasis)) >= contrastThreshold
    ...
    function augmentColor(color, mainShade, lightShade, darkShade) {
        ...
        var main = color.hasOwnProperty("main")
            ? color.main
            : color[MainShade];
        var contrastText = color.hasOwnProperty("contrastText")
            ? color.contrastText
            : getContrastText(main);
        var _a = getLightAndDark(color, main, [LightShade, DarkShade], tonalOffset), lightColor = _a.light, darkColor = _a.dark;
        return {
            main: main,
            light: lightColor,
            dark: darkColor,
    ...
    var types = { dark: light, light: light };
    return cjs(__assign({ common: common,
        type: type, primary: augmentColor(primary), secondary: augmentColor(secondary, "A400", "A200", "A700"), status: status,
        grey: grey,
        contrastThreshold: contrastThreshold,
        getContrastText: getContrastText,
        augmentColor: augmentColor,
        tonalOffset: tonalOffset }, types[type]), other);
}
...
function createSpacing(spacingInput) {
    ...
    var transform;
    if (spacingInput instanceof Function)
        transform = spacingInput;
    else
        transform = function (factor) { return factor * spacingInput; };
    function spacing() {
        var args = [];
        ...
        return (args.length > 4 ? args.slice(0, 4) : args).reduce(function (acc, factor) {
...
var createTypography = function (options) {
    var _a = options.rem, rem = _a === void 0 ? 16 : _a, _b = options.allVariants, allVariants = _b === void 0 ? {} : _b;
    var buildVariant = function (size, lineHeight, fontWeight, fontStyle, casing, fontFamily) {
        if (fontFamily === void 0) { fontFamily = undefined; }
        return __assign({ fontFamily: fontFamily,
            fontStyle: fontStyle,
            fontWeight: fontWeight, fontSize: rem * size, lineHeight: fontFamily ? lineHeight * rem : undefined, textTransform: casing }, allVariants);
    };
    var variants = {
...
var _a = Dimensions.get("screen"), SCREEN_WIDTH$1 = _a.width, SCREEN_HEIGHT = _a.height;
